...
export const UPDATE_ON_DUPLICATE_TAXON_SPECIES_PHOTO: Array<keyof TaxonSpeciesPhoto> = ['photoUrl', 'photoCaption', 'photoAuthor', 'photoLicense', 'photoLicenseUrl', 'updatedAt']
