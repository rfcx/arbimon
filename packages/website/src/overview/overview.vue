<template>
  <div v-if="store.selectedProject">
    ...
    <div class="mt-5 grid gap-10 md:grid-cols-5 lg:grid-cols-3">
      <div class="md:col-span-3 lg:col-span-2">
        ...
        <p class="mt-3">
          This projected had been funded by <a
            href="https://www.drna.pr.gov"
            class="underline"
          >PR DRNA</a> (2021-000060) and <a
        ...
        <ul class="mt-3 ml-5 list-square">
          <li>
            <a
              href="https://www.drna.pr.gov"
              class="underline"
          ...
          <li>
            <a
              href="https://www.paralanaturaleza.org/en/"
              class="underline"
            >Para la Naturaleza</a>
          </li>
          <li>
            <a
              href="https://rfcx.org/"
              class="underline"
            >Rainforest Connection (marconi@rfcx.org)</a>
          </li>
        </ul>
      </div>
