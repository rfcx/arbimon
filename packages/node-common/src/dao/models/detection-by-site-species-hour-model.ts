...
import { type DetectionBySiteSpeciesHour } from '../types'
...
export const UPDATE_ON_DUPLICATE_DETECTION_BY_SITE_SPECIES_HOUR: Array<keyof DetectionBySiteSpeciesHour> = ['count', 'countsByMinute', 'updatedAt']
