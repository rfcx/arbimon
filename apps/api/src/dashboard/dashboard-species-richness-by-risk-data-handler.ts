...
import { type DashboardSpeciesRichnessByRiskDataResponse } from '@rfcx-bio/common/api-bio/dashboard/dashboard-species-richness-by-risk'
...
export const dashboardSpeciesRichnessByRiskDataHandler: Handler<DashboardSpeciesRichnessByRiskDataResponse, DashboardSpeciesDataParams> = async (req) => {
  // Inputs & validation
