...
const ROUTE = '/projects/:projectId/dashboard-species-richness-by-risk'
const url = `/projects/${PROJECT_ID_BASIC}/dashboard-species-richness-by-risk`
...
describe(`GET ${ROUTE} (/dashboard-species-richness-by-risk)`, () => {
