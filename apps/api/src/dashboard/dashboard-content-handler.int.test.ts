...
describe(`PATCH ${ROUTE} (dashboard content)`, () => {
  ...
  describe('can edit data without changing other rows', async () => {
    beforeEach(async () => {
      await LocationProjectProfile.upsert({ locationProjectId: Number(PROJECT_ID_BASIC), summary: '0', image: '', readme: '0', keyResult: '0', resources: '0', methods: '0', objectives: [], dateStart: null, dateEnd: null })
    })
