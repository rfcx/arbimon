...
describe('happy path', () => {
  ...
  test(`GET ${ROUTE} does not contain any additional props`, async () => {
    ...
    const response = await app.inject({
      method: GET,
      url: richnessDatasetUrl({ projectId: '1' }),
      query: { dateStartUtcInclusive: '2001-01-01T00:00:00.000Z', dateEndUtcInclusive: '2021-01-01T00:00:00.000Z' }
    })
...
describe('validate known data', () => {
  test(`GET ${ROUTE} does not have any data on given date`, async () => {
    ...
    const response = await app.inject({
      method: GET,
      url: richnessDatasetUrl({ projectId: '1' }),
      query: { dateStartUtcInclusive: '2001-01-01T00:00:00.000Z', dateEndUtcInclusive: '2002-01-01T00:00:00.000Z' }
    })
