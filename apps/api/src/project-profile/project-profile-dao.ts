...
export const updateProjectProfile = async (locationProjectId: number, summary: string | undefined, readme: string | undefined): Promise<LocationProjectProfile | undefined> => {
