...
import { queryDirectoryProjects, getDirectoryProjects as getDirectoryProjectsFromMock } from './get-directory-projects-dao'
...
export const getDirectoryProjects = async (req: DirectoryProjectsQuery): Promise<DirectoryProjectsResponse> => {
  ...
  return queryDirectoryProjects(isFull, ids, keywords)
}
