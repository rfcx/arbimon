...
const SQL_INSERT_SITE = `
  ...
  VALUES ($projectId, $siteId, $createdAt, $updatedAt, $name, $siteTypeId, $lat, $lon, $alt, $published, $tokenCreatedOn, $externalId, $timezone, $country, $countryCode, $deletedAt);
`
...
const DEFAULT_SITE = { projectId: 1920, siteId: 123, createdAt: '2022-01-01 01:00:00', updatedAt: '2022-01-06 01:00:00', name: 'Site 3', siteTypeId: 2, lat: 16.742010693566815, lon: 100.1923308193772, alt: 0.0, published: 0, tokenCreatedOn: null, externalId: 'cydwrzz91cbz', timezone: 'Asia/Bangkok', country: 'Thailand', countryCode: 'TH', deletedAt: null }
