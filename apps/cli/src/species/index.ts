...
async function updateSpeciesData (species: Species): Promise<Species> {
  ...
  const information = [
    ...(informationIucn ? [{ description: informationIucn ?? '', sourceType: SPECIES_SOURCE_IUCN, sourceUrl: getSpeciesRedirectLink(species.scientificName), sourceCite: 'IUCN 2021. IUCN Red List of Threatened Species. Version 2021-2 <www.iucnredlist.org>' }] : []),
