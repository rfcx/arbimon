...
import { type UpdateUserProfileRequestBody, type UserProfileResponse, apiGetUserProfile, apiUpdateUserProfile } from '@rfcx-bio/common/api-bio/users/profile'
...
export const useGetProfileData = (apiClient: AxiosInstance): UseQueryReturnType<UserProfileResponse | undefined, unknown> => {
  return useQuery({
