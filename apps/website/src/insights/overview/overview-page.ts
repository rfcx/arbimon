...
import type { HighlightedSpeciesRow } from './components/dashboard-highlighted-species/dashboard-highlighted-species.vue'
...
import type { ThreatenedSpeciesRow } from './components/dashboard-species/types'
