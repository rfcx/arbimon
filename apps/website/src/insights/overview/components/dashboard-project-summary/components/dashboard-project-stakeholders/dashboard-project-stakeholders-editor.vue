        ...
        <div class="flex items-center">
          ...
          >
            <div class="relative">
              ...
              >
                <icon-custom-input-loader class="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" />
            ...
            >
              <div class="max-w-sm mx-auto p-3">
                ...
                <div class="flex w-full flex-row justify-end px-3 py-2">
                  <button
                    type="submit"
