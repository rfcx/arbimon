...
export const useUpdateDashboardStakeholderOrganizations = (apiClient: AxiosInstance, projectId: number): UseMutationReturnType<UpdateDashboardStakeholderOrganizationsResponseBody, unknown, number[], unknown, unknown> => {
  return useMutation({
