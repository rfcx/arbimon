<template>
  <div
    id="share-insight-information-modal"
...
onMounted(() => {
  modal.value = new Modal(document.getElementById('share-insight-information-modal'), {
    placement: 'top-right',
    backdrop: 'static',
