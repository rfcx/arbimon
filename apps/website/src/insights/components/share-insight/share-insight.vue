...
const props = defineProps<{ modelValue: 'start-show' | 'start-hide' | 'idle' }>()
const emit = defineEmits<{(event: 'update:modelValue', value: 'start-show' | 'start-hide' | 'idle'): void, (event: 'emit-share-insight-successful'): void, (event: 'emit-hide-insight-successful'): void}>()
