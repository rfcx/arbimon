    ...
    <section-title>
      <template #title>
        <div class="lg:(flex flex-row items-center) text-subtle">
          ...
          <span class="text-xl ml-2 font-header">
            by
          </span>
          <select
            v-model="selectedBucket"
            class="text-xl lowercase ml-2 py-1 bg-echo font-header border-t-0 border-l-0 border-r-0 border-b-1 border-dashed cursor-pointer focus:(border-box-gray border-t-0 border-l-0 border-r-0 border-b-1 ring-0 outline-none)"
          >
            <option
