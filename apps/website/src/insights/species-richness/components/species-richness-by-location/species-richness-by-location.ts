...
import { generateHtmlPopup } from '@/insights/species-richness/components/species-richness-by-location/functions'
import { MAP_KEY_RICHNESS_TOTAL } from '@/insights/species-richness/functions'
