...
export const restoration: ProjectDetail = {
  ...
  impact: {
    ...
    paragraphs: [
      ...
      `Results:
      1. A total of 178 species were detected in the 120 sampling sites (166 birds, 8 frogs, 2 mammals, and 2 insects), 4 of which are listed as threatened according to IUCN. 1. The total number of bird species detected in this study corresponds to 94% of species detected in other individual studies in the same study area, most of which used point count surveys. This result indicates that most species expected to occur in the region have been detected during our initial survey.
