...
For us, the main factor contributing to job cost is the number of recordings included in the analysis (the playlist size). A job on a playlist containing 1,000 recordings typically costs between 20c and $1 depending on the analysis type. We are currently funding the cost through donations and sponsorship, for more information see [how we make Arbimon free](/faq#why-is-arbimon-free).
...
As an environmental organization, we would like to minimize both the monetary cost and the energy cost of running analysis jobs. We request that users act responsibly to only run analysis over the minimum dataset and that they perform tests on smaller datasets (e.g. less than 1000 recordings) to gain confidence before running on larger datasets. This will not only help us to keep the platform free for everyone, but also reduce the carbon footprint on conducting ecological analyses.`
  ...
  },
  {
    ...
    answer: `If you are publishing scientific work, offering workshops and talks, then please _cite Arbimon_. Other ways you can contribute include:

- _Reach out_ to our team to collaborate (e.g. partner with us in a project proposal, [see our past partnership project here](/featured))
- Make your project insights public - Public projects enable open collaboration, which is essential to to improve ecological knowledge and conservation efforts, facilitate break through discoveries and share insights and findings with the world. We take your data privacy seriously. We will never share and divulge sensitive information from the users and datasets, and you can decide on what data you are sharing. Learn more about our data privacy here.
- Share your work on social media with us by tagging our accounts (found in the footer of our www.arbimon.org), and using the hashtags: #arbimon, #rainforestcx, #usingtechtoprotect
- Participate in the conservations on our [ecoacoustic community forum](/forum)`
  },
  {
    question: 'How should Arbimon be cited?',
    answer: 'Our preferred publication for references is: [https://doi.org/10.7717/peerj.103](https://doi.org/10.7717/peerj.103)'
  }
]
