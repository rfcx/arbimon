      ...
      <template #title>
        <div class="sm:(flex flex-row items-center)">
          ...
          <select
            ...
            class="text-xl lowercase sm:(ml-2) py-1 bg-mirage-grey border-t-0 border-l-0 border-r-0 border-b-1 focus:(border-box-grey border-t-0 border-l-0 border-r-0 border-b-1 ring-0 outline-none)"
          >
            <option
