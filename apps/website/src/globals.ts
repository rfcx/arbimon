...
export const apiClientArbimonKey = Symbol('apiClientArbimonKey') as InjectionKey<AxiosInstance>
export const apiClientGeoKey = Symbol('apiClientGeoKey') as InjectionKey<AxiosInstance>
