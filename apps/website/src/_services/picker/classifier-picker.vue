<template>
  <select
    ...
    class="bg-pitch border border-frequency h-44px text-insight text-base rounded-md block w-full p-3 font-sans border border-1 focus:border-frequency focus:outline-none focus:ring-0"
  >
    <option
