import type { type AxiosInstance } from 'axios'
...
import type { type GroupedBarChartItem } from '~/charts/horizontal-bar-chart'
import type { type ColoredFilter } from '~/filters'
import { ComparisonListComponent, filterToQuery } from '~/filters'
import type { type MapDataSet } from '~/maps/types'
import type { type BiodiversityStore } from '~/store'
import type { type TimeBucket } from '~/time-buckets'
...
import type { type DetectedSpeciesItem } from './components/species-richness-detected-species/types'
