<template>
  ...
  >
    ...
    <div>
      <label class="block text-sm mb-1 font-bold">Validations by species/song type</label>
      <SelectMultiple
    ...
    <div>
      <label class="block text-sm mb-1 font-bold">Soundscape Composition</label>
      <SelectMultiple
    ...
    <div>
      <label class="block text-sm mb-1 font-bold">Tags</label>
      <SelectMultiple
    ...
    <div>
      <label class="block text-sm mb-1 font-bold">Grouping of Detections</label>
      <div
        ref="dropdownRef"
    ...
    <div>
      <label class="block text-sm mb-1 font-bold">Species detection matrix</label>
      <SelectMultiple
