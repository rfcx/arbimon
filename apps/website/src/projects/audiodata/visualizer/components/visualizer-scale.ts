...
// specH (zoomed content height) is CORRECT here under the scroll-based
// vertical-zoom model (2026-07-20 v2): content grows downward and the axis
// rides its bottom; the zoom watcher auto-scrolls it into view.
