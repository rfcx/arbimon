        ...
        <div>
          ...
          <div class="relative w-full">
            <input
              ...
              class="placeholder-style w-full border border-cloud rounded-md dark:(bg-pitch text-insight placeholder:text-insight) focus:(border-frequency ring-frequency) placeholder-util-gray-02"
              required
