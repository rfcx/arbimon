...
const stats = computed(() => [
  ...
  { value: 'species', title: 'Species added', description: 'Total species added to the project', count: metrics.value?.totalSpecies ?? 0, isLoading: isLoadingMetrics.value, label: 'Add new species', link: `${BASE_URL}/project/${selectedProject.value?.slug}/audiodata/species` }
])
