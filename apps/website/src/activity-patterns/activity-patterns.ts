...
import { type PredictedOccupancyMap, apiBioGetProjectSpeciesOne } from '@rfcx-bio/common/api-bio/species/project-species-one'
import { type SpotlightExportData, apiBioGetSpotlightDataset } from '@rfcx-bio/common/api-bio/spotlight/spotlight-dataset'
...
import { type SpotlightTimeDataset } from './components/activity-patterns-by-time/activity-patterns-by-time'
