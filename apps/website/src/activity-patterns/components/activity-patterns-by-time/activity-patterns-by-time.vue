      ...
      <template #title>
        <div class="lg:(flex flex-row items-center) text-subtle">
          ...
          <select
            ...
            class="text-xl lowercase ml-2 py-1 bg-mirage-grey border-t-0 border-l-0 border-r-0 border-b-1 border-dashed cursor-pointer focus:(border-box-grey border-t-0 border-l-0 border-r-0 border-b-1 ring-0 outline-none)"
          >
            <option
